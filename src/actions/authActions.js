...
import {LOGOUT, AUTH_ERROR,SET_CURRENT_USER, SUCCESFUL_REGISTER, FAILED_REGISTER, ERRORS, SUCCESFUL_LOGIN, FAILED_LOGIN} from "./types";

export const setCurrentUser = (user) =>async dispatch=>{ //sets the state "user"
